...
def main():
    ...
    # print to file to confirm output that is cut off in Visual Studio Code
    #with open('words.txt', mode='w') as grades:
    #    phonewords = " ".join(words)
    #    print(phonewords, file=grades)
